/*$(function () {
    ...
    function buildFillInBody(aObj) {
        ...
        // ===================================================================== all_cont =====================
                ...
                htmlStmt += '<div class="all_cont justify-content-center ht_100 align-items-center d-flex flex-column">';

                if(aObj.image != undefined && aObj.image != ""){
                    htmlStmt += "<img src='" + aObj.image + "' class='q_img' />";
                }
                ...
                for (x = 0; x < numOfRows; x++) {
                    ...
                    for (y = 0; y < numInRowArray[x].length; y++) {
                        ...
                        htmlStmt += '<div class="p-0  q_cont" style="height: 80px">'; // put hight in css or data 
