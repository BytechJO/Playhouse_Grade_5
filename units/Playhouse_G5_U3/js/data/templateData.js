var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/page_20/UNIT_03_Getting_Involved.mp3",
       "title":{
    ...
    "footer": {
        ...
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : 'Playhouse_Review_G5_U3/views/fillin_text_in_sentences_2_2.html'
        },
        "booksbutton" : { 
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_G5_WB/views/circle_word_in_sentence.html'
            },
            "studentbook": {
