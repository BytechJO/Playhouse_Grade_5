        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "letterpath":
              ...
              break;
            case "findItVerbObject":
              if (
                typeof find_it_verb_object_data != undefined &&
                find_it_verb_object_data != null
              ) {
                buildFindItVerbObjectBody(find_it_verb_object_data);
              }
              break;
            case "spotit":
              if (typeof spotit_data != undefined && spotit_data != null) {
                buildSpotItBody(spotit_data);
              }
              break;
            case "unscramble":
              if (
                typeof unscramble_data != undefined &&
                unscramble_data != null
              ) {
                buildUnscrambleBody(unscramble_data);
              }
              break;
               case "fillcircleword":
              if (
                typeof fillcircleword_data != undefined &&
                fillcircleword_data != null
              ) {
                buildFillCircleWordBody(fillcircleword_data);
              }
              break;
          }
        } else {
