var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/page_4/UNIT_01_Taking_It_to_the_Extreme.mp3",
       "title":{
           "text": "Talking It to the Extreme",
    ...
    "footer": {
        ...
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : 'Playhouse_Review_G5_U1/views/fillin_text_in_sentences_4.html'
        },
        "booksbutton" : {
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_G5_WB/views/WB_U1_Q1.html'
            },
            "studentbook": {
