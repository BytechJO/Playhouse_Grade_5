function buildFillInBody(aObj) {	
	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		htmlStmt += '</div>';
			htmlStmt += '<div class="grid-container">'
				htmlStmt += '<div class="grid-item">• How to plan a party</div>'
				htmlStmt += '<div class="grid-item">• How to organise a clean-up day at your school</div>'
				htmlStmt += '<div class="grid-item">• How to stop pollution</div>'
				htmlStmt += '<div class="grid-item">• How to stay safe on the internet</div>'
				htmlStmt += '<div class="grid-item">• How to recycle bottles and plastic</div>'
				htmlStmt += '<div class="grid-item">• How to babysit </div>'
			htmlStmt += '</div>'
