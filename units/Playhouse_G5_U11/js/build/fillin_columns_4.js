	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		for (x = 0; x < numOfRows; x++) {
			...
			for (y = 0; y < numInRowArray[x].length; y++) {
				...
				htmlStmt += '<div class="txtBox d-flex ' + (x%2==0? "flex-column" : "") + ' "data-type="text">';
				
				if(textFront !=""){
					if(((aObj.questions)[currentQue - 1]).hintText){
						htmlStmt += '<div class="hintText">' + ((aObj.questions)[currentQue - 1]).hintText + '</div>';
					}
