var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/page_48/UNIT_06_Then_and_Now.mp3",
       "title":{
           "text": "Then and Now",
    ...
    "footer": {
        ...
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : 'Playhouse_Review_G5_U6/views/fillin_text_in_sentences_2_2.html'
        },
        "booksbutton" : { 
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_G5_WB/views/multiple_choice_p29.html'
            },
            "studentbook": {
