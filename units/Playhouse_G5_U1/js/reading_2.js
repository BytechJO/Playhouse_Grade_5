...
function callReadingFunctions(_activityData, _actIndx) {
    ...
    // ملاحظة: استدعاء buildMCQCircleBox انتقل لداخل buildReadingHTML مباشرة
    // (بملف buildReadingHTML.js) عشان يضمن التنفيذ دايمًا، بغض النظر عن أي
    // خطأ ممكن يصير هون قبل ما يوصل الكود لهاد المكان (مثل setReadingSlideNumber)
