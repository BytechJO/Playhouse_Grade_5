	...
	*/
	...
	jQuery.each(activity.questions, function(key, values){
		...
		if(typeof(values)=="string"){
			...
			html += `<div class='flex-cell ${key%2 == 0 ? 'gray-col': ''}' style="flex: 1;border: 1px solid #ccc;padding: 10px;text-align: center;min-width: 25%;">`+ values.replace(/___/g, ` <input readonly type="text" class="droppable_div ${styleInputOption}" />`) +'</div>';
