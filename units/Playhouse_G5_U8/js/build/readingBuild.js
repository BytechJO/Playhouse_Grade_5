        ...
        for (var slideIndex = 0; slideIndex < aObj.slides.length; slideIndex++) {
            ...
            if (slide.layout == 'text_on_image'){
                ...
                slideHtml += "</div>";
                    ...
                    var wordArray = slide.word;
                    var imageArray = slide.image;
                    slideHtml += "<div class='d-flex justify-content-center grid_columns_container " + slide.parent_class_name + "' style='flex-direction:column; gap:20px'>";
                        slideHtml += "<div class='col_grid_container'>";
                        ...
                        slideHtml += "</div>";
                            slideHtml += '<div class="activityHeading">'
            slideHtml += '<div class="audioIcon off contant audioQuestionTitle" data-slideNum="' + 1 + '" data-audio="' + aObj.subTitleTextRight2Audio + '">';
            slideHtml += "<div class='page_sub_title'>";
                slideHtml += "<p> " + aObj.subTitleTextRight2 + " </p>";
                for (var sicons = 0 ; sicons < aObj.subTitleIcons.length ; sicons++) {
                    slideHtml += "<img src='" + aObj.subTitleIcons[sicons] + "'/>";
                }
