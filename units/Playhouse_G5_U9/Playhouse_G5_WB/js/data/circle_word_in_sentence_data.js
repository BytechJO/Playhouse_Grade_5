...
var mcq_data = {    
    ...
    "questions"             : [
        ...
        {
            "question"              : "This mobile phone has a memory card of one ([_]).",
            "options"               : [["byte","bite"]],
            "answer"                : [1],
			"inputbox"				: "yes",
			"image"					: '',
        ...
        {
            "question"              : "What would you like to eat for ([_])?",
        ...
        {
            "question"              : "The teacher ([_]) us to play games.",
        ...
        {
            "question"              : "Would you please ([_]) the invitation to my party? ",
        ...
        {
            "question"              : "We ([_])eat at this restaurant.",
            "options"               : [["sometimes","some times"]],
            "answer"                : [1],
			"inputbox"				: "yes",
			"image"					: '',
            "audio"                 : "",
        ...
        {
            "question"              : "On a nice sunny morning, we walked by the  ([_]).",
            "options"               : [["creak","creek"]],
            "answer"                : [2],
			"inputbox"				: "yes",
			"image"					: '',
