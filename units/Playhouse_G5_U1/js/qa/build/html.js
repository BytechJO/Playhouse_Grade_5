...
function writeHtml(activity, activity_html){
	...
	htmlStmt += '<div class="act_head_group justify-content-center">';
		...
		if(activity.images != undefined & activity.images != ""){
			imgSpace = '<div class="img_space d-flex flex-column">';
			for(let i=0; i<activity.images.length; i++){
				imgSpace += '<img src="'+activity.images[i]+'"></img>';
			}		
			imgSpace += '</div>';
		}
	...
	htmlStmt +
	'<div class="activity-content d-flex h-100 ">'+imgSpace+activity_html+'</div>');
}
