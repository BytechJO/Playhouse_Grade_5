    ...
    if (aObj != undefined && aObj != null) {
        ...
        if (layOut == 1) {
            ...
            for (x = 0; x < numOfQuestions; x++) {
                ...
                htmlStmt += '<div  id="que_' + (x + 1) + '" class="que d-flex" data-qno="' + (x + 1) + '">';
            ...
            htmlStmt += '</div>';
            if(aObj.images){
               htmlStmt += '<div class="images_free">';
               htmlStmt += '<img src="' + aObj.images[0] + '" class="img-'+1+'">';  
               htmlStmt += '<img src="' + aObj.images[1] + '" class="img-'+2+'">';  
               htmlStmt += '</div>';  
