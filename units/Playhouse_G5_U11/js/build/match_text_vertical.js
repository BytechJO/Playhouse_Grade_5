...
htmlStmt += '<div class="opt drag d-flex align-items-center" id="drag_' + (currentQue) + '_' + (dg + 1) + '" data-group="' + dragsArr[dg].group + '">';
        ...
        if (dropsArr.length > 0) {
         ...
         htmlStmt += '<div class="opt drop d-flex align-items-center" id="drop_' + (currentQue) + '_' + (dp + 1) + '" data-group="' + dropsArr[dp].group + '">';
