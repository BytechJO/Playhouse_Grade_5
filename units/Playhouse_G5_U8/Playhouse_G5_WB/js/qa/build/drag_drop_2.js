function initActivity(activity){
	...
	//Questions
	drag_drop_questions = '<div class="drag_drop_questions"><ul  class="que d-flex flex-wrap h-100">';
	img_array = activity.images
	jQuery.each(activity.questions, function(key, values){
		drag_drop_questions += '<li class="d-flex flex-wrap" style=" width: 985px;"><ul>';
