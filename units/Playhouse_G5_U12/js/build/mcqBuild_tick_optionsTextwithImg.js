        ...
        if (layOut == 1) {
            ...
            for (x = 0; x < numOfQuestions; x++) {
             ...
             //   htmlStmt += '<div class="image_wrap"><img src="' + tempObj.image + '"></div>';
                ...
                htmlStmt += '<div class="ans_grup que_group d-flex flex-column gap-20">';
                for (y = 0; y < ((tempObj).options).length; y++) {
                    htmlStmt += ' <div id="pick_' + (x + 1) + '_' + (y + 1) + '" class="tick_field d-flex gap-20 pick "> ';
            ...
            htmlStmt +=aObj.image ? '<div class="image_wrap"><img src="' + aObj.image + '"></div>' :'';
        }
    }
