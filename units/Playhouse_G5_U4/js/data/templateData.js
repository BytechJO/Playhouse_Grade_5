var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/page_32/UNIT_04_Let’s_Go_Shopping!.mp3",
       "title":{
    ...
    "footer": {
        ...
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : 'Playhouse_Review_G5_U4/views/fillin_text_in_sentences_4.html'
        },
        "booksbutton" : { 
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_G5_WB/views/drag_drop_text_table.html'
            },
            "studentbook": {
