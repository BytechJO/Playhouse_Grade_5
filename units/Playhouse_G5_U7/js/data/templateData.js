var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/page_60/UNIT_07_Our_Planet.mp3",
       "title":{
           "text": "Our Planet",
    ...
    "footer": {
        ...
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : 'Playhouse_Review_G5_U7/views/fillin_text_in_sentences_4.html'
        },
        "booksbutton" : { 
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_G5_WB/views/drag_drop_text_1.html'
            },
            "studentbook": {
