...
function buildHeader(aObj) {
  ...
  if (typeof aObj != undefined && aObj != null) {
    ...
    if (typeof aObj.icon != undefined && aObj.icon != null) {
      ...
      fStmt += "<a href='" + _templatePath + aObj.grammer_link + "'>";
      ...
      fStmt += "<a href='" + _templatePath + aObj.vocabulary_link + "'>";
      ...
      fStmt += "<a href='" + _templatePath + aObj.poster_link + "'>";
...
function buildStudentPagesSidebar() {
  ...
  var sStmt = '<div class="studentPagesSidebar" id="studentPagesSidebar">';

  sStmt += '<div class="studentPagesSidebarHeader">';
  ...
  sStmt += '<div class="studentPagesSidebarList">';
  ...
  $(document)
    .off("click.studentPagesMenu", "#studentPagesToggle")
    .on("click.studentPagesMenu", "#studentPagesToggle", function (event) {
      event.preventDefault();
      event.stopPropagation();

      $("#studentPagesSidebar").addClass("open");

      $("#studentPagesSidebarOverlay").addClass("show");
    });
  ...
  $(document)
    ...
    .on(
      ...
      "#studentPagesSidebarClose, #studentPagesSidebarOverlay",
      function () {
        $("#studentPagesSidebar").removeClass("open");

        $("#studentPagesSidebarOverlay").removeClass("show");
      },
    );

  $(document)
    .off("keydown.studentPagesMenu")
    .on("keydown.studentPagesMenu", function (event) {
      if (event.key === "Escape") {
        $("#studentPagesSidebar").removeClass("open");
