...
function buildFillInBody(aObj) {
    ...
    if (aObj != undefined && aObj != null) {
        ...
        if (layOut == 4) {
            ...
            htmlStmt += '<div id="static-text" style="width: 25%; position: absolute; left: 550px;">Dear Diary,</div>';
            htmlStmt += ' <textarea id="paper-textarea" rows="10" cols="50" maxlength="170"></textarea>';
            htmlStmt += '</div>';
