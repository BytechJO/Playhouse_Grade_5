var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/page_104/UNIT_12_When_I_Grow_Up.mp3",
       "title":{
           "text": "When I Grow Up",
    ...
    "footer": {
        ...
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : 'Playhouse_Review_G5_U12/views/fillin_text_in_sentences_4.html'
        },
        "booksbutton" : { 
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_G5_WB/views/drag_drop_text.html'
            },
            "studentbook": {
