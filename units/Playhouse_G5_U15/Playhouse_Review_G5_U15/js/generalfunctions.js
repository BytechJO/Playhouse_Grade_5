      ...
      if (_fileType != "" && _fileBuild != "") {
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "completeit":
              if (
                typeof completeit_data != undefined &&
                completeit_data != null
              ) {
                buildCompleteItBody(completeit_data);
              }
              break;
            case "tickit":
              if (typeof tickit_data != undefined && tickit_data != null) {
                buildTickItBody(tickit_data);
              }
              break;
            case "bookmark":
              if (typeof bookmark_data != undefined && bookmark_data != null) {
                buildBookmarkBody(bookmark_data);
              }
              break;
          }
        } else {
