function buildMcqTickBody(aObj) {
    ...
    if (aObj != undefined && aObj != null) {
        ...
        if (layOut == 1) {
            ...
            htmlStmt += '<div class="tick_group" style="width:100%">'; 
            for (x = 0; x < numOfQuestions; x++) {
             ...
             //   htmlStmt += '<div class="image_wrap"><img src="' + tempObj.image + '"></div>';
                ...
                htmlStmt += '<div class="ans_grup que_group d-flex gap-20 justify-content-center" style="height: 300px;justify-content: space-evenly !important;">';
