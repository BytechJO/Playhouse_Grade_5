function buildFillInBody(aObj) {	
	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		htmlStmt += '<div class="group_elm">';
			htmlStmt += '<div>';
			htmlStmt += '<h2 style="display: block;">Directions:</h2>';
			htmlStmt += '<ul>';
			htmlStmt += '<li>Write four questions to ask your classmates.</li>';
			htmlStmt += '<li>Write the verbs from your questions in the boxes in the blue table below.</li>';
			htmlStmt += '<li>Record your classmates’ answers in the table.</li>';
			htmlStmt += '</ul>';
			htmlStmt += '</div>';
			...
			for (x = 0; x < numOfQuestions; x++) {
				...
				htmlStmt += '<div class="fillin_gr align-items-center">';
