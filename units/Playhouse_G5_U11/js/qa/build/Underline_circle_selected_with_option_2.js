function initActivity(activity){
	...
	jQuery.each(activity.questions, function(key, question){
		...
		html += '<li><span class="question_text">'+question+'</span><span type="text" class="lineVal" value="" style="display: none;"/>&nbsp;&nbsp;<span type="text" class="circleVal" value="" style="display: none;"/>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="getSelectedCircleText(this)">&check;</a></li>';
	});
	html += '</ul>';
	// html += '</div>';
