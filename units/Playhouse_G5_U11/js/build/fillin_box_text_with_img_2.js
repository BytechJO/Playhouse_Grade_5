      ...
      if (tmpObj.singleword) {
        ...
        qStr = words.map((word, index) => {
          if (word !== '') {
            wordIndex++;
            if (x==1){
              var arr = '<p class="m-arro">&rarr;</p><div class="audioIcon txt-audioIcon background_audio off contant min_w_fit_contant" data-audio="' + tmpObj.textaudios[wordIndex] + '">' + word + '</div>';
            } else {
              var arr = '<div class="audioIcon txt-audioIcon background_audio off contant min_w_fit_contant" data-audio="' + tmpObj.textaudios[wordIndex] + '">' + word + '</div><p class="m-arro">&rarr;</p>';
            }
            return arr;
          }
