var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/page_116/UNIT_13_History_Was_Made.mp3",
       "title":{
           "text": "History Was Made!",
    ...
    "footer": {
        ...
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : 'Playhouse_Review_G5_U13/views/fillin_text_in_sentences_4.html'
        },
        "booksbutton" : { 
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_G5_WB/views/WB_G4_U2_P12_2.html'
            },
            "studentbook": {
