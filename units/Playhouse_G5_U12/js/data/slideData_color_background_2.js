var stereo_data = {
    ...
    "playListData" : [
        {
          'audiourl': '../audios/page_110/A_policeman_has_to_do_the_following.mp3',
        },
        {
          'url': '',
        },
...
var reading_data = {
    ...
    "subTitleTextRight": "Read the following brainstorming list that includes the jobs of a policeman.",
    "subTitleIcons": [""],
    "subTitleAudio": "../audios/page_110/1_Read_about_it!.mp3",
    "slides": [
        {
            "layout": "grid_columns",
