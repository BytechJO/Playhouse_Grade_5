...
function initiateActivityType(aActTyp, aActSubType) {
  ...
  } else if (aActTyp == "findItVerbObject") {
    theActivity = new FindItVerbObject(quePart, find_it_verb_object_data);
  }else if (aActTyp == "fillcircleword") {
    theActivity = new FillCircleWord(quePart, fillcircleword_data);
  } else if (aActTyp == "spotit") {
    // ============================================================
    // جديد: نشاط Spot it! - كلاس حقيقي بنفس نمط باقي الأنشطة
    // ============================================================
    theActivity = new SpotIt(quePart, spotit_data);
  } else if (aActTyp == "unscramble") {
