function buildFillInBody(aObj) {	
	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		if (typeof aObj.options != undefined && aObj.options != null) {
			htmlStmt += '<div class="img_options d-flex flex-wrap justify-content-around">';
			for(let i=0; i<aObj.options.length; i++) {
				htmlStmt += '<div class="audioIcon textEnd off d-flex contant" data-audio="'+aObj.optionsAudios[i]+'">' ;
					htmlStmt += '<img src="' + aObj.options[i] + '">';
				htmlStmt += '</div>';
			}
			htmlStmt += '</div>';
		}
		...
		htmlStmt += '<div class="group_elm d-flex flex-wrap">';
			...
			htmlStmt += '<div class="ques_container">';
